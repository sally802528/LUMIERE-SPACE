...
LUMIERE-SPACE 承諾尊重並保護您的隱私。本站所有資料上傳與處理均於**本地端（瀏覽器）**執行，您的圖片與影片檔案絕不會被傳送到任何遠端伺服器，請放心導入任何私密或珍貴的影像資料。
...
>
>目前已知在某些特殊的影片，會導致播放時降低畫面幀率，但由於因素難以掌握，引此目前暫時無法對其做相應修復，你可以將影片進行轉檔，或移除影片以達到最佳效能。
---
